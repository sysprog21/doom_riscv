...
// Action function declarations - C23 compatible
// 2-arg weapon actions (player_t*, pspdef_t*)
...
// Mobj actions (mobj_t*, NULL) - unified signature for C23 compatibility
...
state_t states[NUMSTATES] = {
    ...
    {SPR_BFE1,32770,8,{.acp2 = A_BFGSpray},S_BFGLAND4,0,0},     // S_BFGLAND3
    ...
    {SPR_MISL,32769,8,{.acp2 = A_Explode},S_EXPLODE2,0,0},      // S_EXPLODE1
    ...
    {SPR_PLAY,6,4,{.acp2 = A_Pain},S_PLAY,0,0}, // S_PLAY_PAIN2
    {SPR_PLAY,7,10,{NULL},S_PLAY_DIE2,0,0},     // S_PLAY_DIE1
    {SPR_PLAY,8,10,{.acp2 = A_PlayerScream},S_PLAY_DIE3,0,0},   // S_PLAY_DIE2
    {SPR_PLAY,9,10,{.acp2 = A_Fall},S_PLAY_DIE4,0,0},   // S_PLAY_DIE3
    ...
    {SPR_PLAY,15,5,{.acp2 = A_XScream},S_PLAY_XDIE3,0,0},       // S_PLAY_XDIE2
    {SPR_PLAY,16,5,{.acp2 = A_Fall},S_PLAY_XDIE4,0,0},  // S_PLAY_XDIE3
    ...
    {SPR_POSS,0,10,{.acp2 = A_Look},S_POSS_STND2,0,0},  // S_POSS_STND
    {SPR_POSS,1,10,{.acp2 = A_Look},S_POSS_STND,0,0},   // S_POSS_STND2
    {SPR_POSS,0,4,{.acp2 = A_Chase},S_POSS_RUN2,0,0},   // S_POSS_RUN1
    {SPR_POSS,0,4,{.acp2 = A_Chase},S_POSS_RUN3,0,0},   // S_POSS_RUN2
    {SPR_POSS,1,4,{.acp2 = A_Chase},S_POSS_RUN4,0,0},   // S_POSS_RUN3
    {SPR_POSS,1,4,{.acp2 = A_Chase},S_POSS_RUN5,0,0},   // S_POSS_RUN4
    {SPR_POSS,2,4,{.acp2 = A_Chase},S_POSS_RUN6,0,0},   // S_POSS_RUN5
    {SPR_POSS,2,4,{.acp2 = A_Chase},S_POSS_RUN7,0,0},   // S_POSS_RUN6
    {SPR_POSS,3,4,{.acp2 = A_Chase},S_POSS_RUN8,0,0},   // S_POSS_RUN7
    {SPR_POSS,3,4,{.acp2 = A_Chase},S_POSS_RUN1,0,0},   // S_POSS_RUN8
    {SPR_POSS,4,10,{.acp2 = A_FaceTarget},S_POSS_ATK2,0,0},     // S_POSS_ATK1
    {SPR_POSS,5,8,{.acp2 = A_PosAttack},S_POSS_ATK3,0,0},       // S_POSS_ATK2
    {SPR_POSS,4,8,{NULL},S_POSS_RUN1,0,0},      // S_POSS_ATK3
    {SPR_POSS,6,3,{NULL},S_POSS_PAIN2,0,0},     // S_POSS_PAIN
    {SPR_POSS,6,3,{.acp2 = A_Pain},S_POSS_RUN1,0,0},    // S_POSS_PAIN2
    {SPR_POSS,7,5,{NULL},S_POSS_DIE2,0,0},      // S_POSS_DIE1
    {SPR_POSS,8,5,{.acp2 = A_Scream},S_POSS_DIE3,0,0},  // S_POSS_DIE2
    {SPR_POSS,9,5,{.acp2 = A_Fall},S_POSS_DIE4,0,0},    // S_POSS_DIE3
    ...
    {SPR_POSS,13,5,{.acp2 = A_XScream},S_POSS_XDIE3,0,0},       // S_POSS_XDIE2
    {SPR_POSS,14,5,{.acp2 = A_Fall},S_POSS_XDIE4,0,0},  // S_POSS_XDIE3
    ...
    {SPR_SPOS,0,10,{.acp2 = A_Look},S_SPOS_STND2,0,0},  // S_SPOS_STND
    {SPR_SPOS,1,10,{.acp2 = A_Look},S_SPOS_STND,0,0},   // S_SPOS_STND2
    {SPR_SPOS,0,3,{.acp2 = A_Chase},S_SPOS_RUN2,0,0},   // S_SPOS_RUN1
    {SPR_SPOS,0,3,{.acp2 = A_Chase},S_SPOS_RUN3,0,0},   // S_SPOS_RUN2
    {SPR_SPOS,1,3,{.acp2 = A_Chase},S_SPOS_RUN4,0,0},   // S_SPOS_RUN3
    {SPR_SPOS,1,3,{.acp2 = A_Chase},S_SPOS_RUN5,0,0},   // S_SPOS_RUN4
    {SPR_SPOS,2,3,{.acp2 = A_Chase},S_SPOS_RUN6,0,0},   // S_SPOS_RUN5
    {SPR_SPOS,2,3,{.acp2 = A_Chase},S_SPOS_RUN7,0,0},   // S_SPOS_RUN6
    {SPR_SPOS,3,3,{.acp2 = A_Chase},S_SPOS_RUN8,0,0},   // S_SPOS_RUN7
    {SPR_SPOS,3,3,{.acp2 = A_Chase},S_SPOS_RUN1,0,0},   // S_SPOS_RUN8
    {SPR_SPOS,4,10,{.acp2 = A_FaceTarget},S_SPOS_ATK2,0,0},     // S_SPOS_ATK1
    {SPR_SPOS,32773,10,{.acp2 = A_SPosAttack},S_SPOS_ATK3,0,0}, // S_SPOS_ATK2
    {SPR_SPOS,4,10,{NULL},S_SPOS_RUN1,0,0},     // S_SPOS_ATK3
    {SPR_SPOS,6,3,{NULL},S_SPOS_PAIN2,0,0},     // S_SPOS_PAIN
    {SPR_SPOS,6,3,{.acp2 = A_Pain},S_SPOS_RUN1,0,0},    // S_SPOS_PAIN2
    {SPR_SPOS,7,5,{NULL},S_SPOS_DIE2,0,0},      // S_SPOS_DIE1
    {SPR_SPOS,8,5,{.acp2 = A_Scream},S_SPOS_DIE3,0,0},  // S_SPOS_DIE2
    {SPR_SPOS,9,5,{.acp2 = A_Fall},S_SPOS_DIE4,0,0},    // S_SPOS_DIE3
    ...
    {SPR_SPOS,13,5,{.acp2 = A_XScream},S_SPOS_XDIE3,0,0},       // S_SPOS_XDIE2
    {SPR_SPOS,14,5,{.acp2 = A_Fall},S_SPOS_XDIE4,0,0},  // S_SPOS_XDIE3
    ...
    {SPR_VILE,0,10,{.acp2 = A_Look},S_VILE_STND2,0,0},  // S_VILE_STND
    {SPR_VILE,1,10,{.acp2 = A_Look},S_VILE_STND,0,0},   // S_VILE_STND2
    {SPR_VILE,0,2,{.acp2 = A_VileChase},S_VILE_RUN2,0,0},       // S_VILE_RUN1
    {SPR_VILE,0,2,{.acp2 = A_VileChase},S_VILE_RUN3,0,0},       // S_VILE_RUN2
    {SPR_VILE,1,2,{.acp2 = A_VileChase},S_VILE_RUN4,0,0},       // S_VILE_RUN3
    {SPR_VILE,1,2,{.acp2 = A_VileChase},S_VILE_RUN5,0,0},       // S_VILE_RUN4
    {SPR_VILE,2,2,{.acp2 = A_VileChase},S_VILE_RUN6,0,0},       // S_VILE_RUN5
    {SPR_VILE,2,2,{.acp2 = A_VileChase},S_VILE_RUN7,0,0},       // S_VILE_RUN6
    {SPR_VILE,3,2,{.acp2 = A_VileChase},S_VILE_RUN8,0,0},       // S_VILE_RUN7
    {SPR_VILE,3,2,{.acp2 = A_VileChase},S_VILE_RUN9,0,0},       // S_VILE_RUN8
    {SPR_VILE,4,2,{.acp2 = A_VileChase},S_VILE_RUN10,0,0},      // S_VILE_RUN9
    {SPR_VILE,4,2,{.acp2 = A_VileChase},S_VILE_RUN11,0,0},      // S_VILE_RUN10
    {SPR_VILE,5,2,{.acp2 = A_VileChase},S_VILE_RUN12,0,0},      // S_VILE_RUN11
    {SPR_VILE,5,2,{.acp2 = A_VileChase},S_VILE_RUN1,0,0},       // S_VILE_RUN12
    {SPR_VILE,32774,0,{.acp2 = A_VileStart},S_VILE_ATK2,0,0},   // S_VILE_ATK1
    {SPR_VILE,32774,10,{.acp2 = A_FaceTarget},S_VILE_ATK3,0,0}, // S_VILE_ATK2
    {SPR_VILE,32775,8,{.acp2 = A_VileTarget},S_VILE_ATK4,0,0},  // S_VILE_ATK3
    {SPR_VILE,32776,8,{.acp2 = A_FaceTarget},S_VILE_ATK5,0,0},  // S_VILE_ATK4
    {SPR_VILE,32777,8,{.acp2 = A_FaceTarget},S_VILE_ATK6,0,0},  // S_VILE_ATK5
    {SPR_VILE,32778,8,{.acp2 = A_FaceTarget},S_VILE_ATK7,0,0},  // S_VILE_ATK6
    {SPR_VILE,32779,8,{.acp2 = A_FaceTarget},S_VILE_ATK8,0,0},  // S_VILE_ATK7
    {SPR_VILE,32780,8,{.acp2 = A_FaceTarget},S_VILE_ATK9,0,0},  // S_VILE_ATK8
    {SPR_VILE,32781,8,{.acp2 = A_FaceTarget},S_VILE_ATK10,0,0}, // S_VILE_ATK9
    {SPR_VILE,32782,8,{.acp2 = A_VileAttack},S_VILE_ATK11,0,0}, // S_VILE_ATK10
    ...
    {SPR_VILE,16,5,{.acp2 = A_Pain},S_VILE_RUN1,0,0},   // S_VILE_PAIN2
    {SPR_VILE,16,7,{NULL},S_VILE_DIE2,0,0},     // S_VILE_DIE1
    {SPR_VILE,17,7,{.acp2 = A_Scream},S_VILE_DIE3,0,0}, // S_VILE_DIE2
    {SPR_VILE,18,7,{.acp2 = A_Fall},S_VILE_DIE4,0,0},   // S_VILE_DIE3
    ...
    {SPR_FIRE,32768,2,{.acp2 = A_StartFire},S_FIRE2,0,0},       // S_FIRE1
    {SPR_FIRE,32769,2,{.acp2 = A_Fire},S_FIRE3,0,0},    // S_FIRE2
    {SPR_FIRE,32768,2,{.acp2 = A_Fire},S_FIRE4,0,0},    // S_FIRE3
    {SPR_FIRE,32769,2,{.acp2 = A_Fire},S_FIRE5,0,0},    // S_FIRE4
    {SPR_FIRE,32770,2,{.acp2 = A_FireCrackle},S_FIRE6,0,0},     // S_FIRE5
    {SPR_FIRE,32769,2,{.acp2 = A_Fire},S_FIRE7,0,0},    // S_FIRE6
    {SPR_FIRE,32770,2,{.acp2 = A_Fire},S_FIRE8,0,0},    // S_FIRE7
    {SPR_FIRE,32769,2,{.acp2 = A_Fire},S_FIRE9,0,0},    // S_FIRE8
    {SPR_FIRE,32770,2,{.acp2 = A_Fire},S_FIRE10,0,0},   // S_FIRE9
    {SPR_FIRE,32771,2,{.acp2 = A_Fire},S_FIRE11,0,0},   // S_FIRE10
    {SPR_FIRE,32770,2,{.acp2 = A_Fire},S_FIRE12,0,0},   // S_FIRE11
    {SPR_FIRE,32771,2,{.acp2 = A_Fire},S_FIRE13,0,0},   // S_FIRE12
    {SPR_FIRE,32770,2,{.acp2 = A_Fire},S_FIRE14,0,0},   // S_FIRE13
    {SPR_FIRE,32771,2,{.acp2 = A_Fire},S_FIRE15,0,0},   // S_FIRE14
    {SPR_FIRE,32772,2,{.acp2 = A_Fire},S_FIRE16,0,0},   // S_FIRE15
    {SPR_FIRE,32771,2,{.acp2 = A_Fire},S_FIRE17,0,0},   // S_FIRE16
    {SPR_FIRE,32772,2,{.acp2 = A_Fire},S_FIRE18,0,0},   // S_FIRE17
    {SPR_FIRE,32771,2,{.acp2 = A_Fire},S_FIRE19,0,0},   // S_FIRE18
    {SPR_FIRE,32772,2,{.acp2 = A_FireCrackle},S_FIRE20,0,0},    // S_FIRE19
    {SPR_FIRE,32773,2,{.acp2 = A_Fire},S_FIRE21,0,0},   // S_FIRE20
    {SPR_FIRE,32772,2,{.acp2 = A_Fire},S_FIRE22,0,0},   // S_FIRE21
    {SPR_FIRE,32773,2,{.acp2 = A_Fire},S_FIRE23,0,0},   // S_FIRE22
    {SPR_FIRE,32772,2,{.acp2 = A_Fire},S_FIRE24,0,0},   // S_FIRE23
    {SPR_FIRE,32773,2,{.acp2 = A_Fire},S_FIRE25,0,0},   // S_FIRE24
    {SPR_FIRE,32774,2,{.acp2 = A_Fire},S_FIRE26,0,0},   // S_FIRE25
    {SPR_FIRE,32775,2,{.acp2 = A_Fire},S_FIRE27,0,0},   // S_FIRE26
    {SPR_FIRE,32774,2,{.acp2 = A_Fire},S_FIRE28,0,0},   // S_FIRE27
    {SPR_FIRE,32775,2,{.acp2 = A_Fire},S_FIRE29,0,0},   // S_FIRE28
    {SPR_FIRE,32774,2,{.acp2 = A_Fire},S_FIRE30,0,0},   // S_FIRE29
    {SPR_FIRE,32775,2,{.acp2 = A_Fire},S_NULL,0,0},     // S_FIRE30
    ...
    {SPR_FATB,32768,2,{.acp2 = A_Tracer},S_TRACER2,0,0},        // S_TRACER
    {SPR_FATB,32769,2,{.acp2 = A_Tracer},S_TRACER,0,0}, // S_TRACER2
    ...
    {SPR_SKEL,0,10,{.acp2 = A_Look},S_SKEL_STND2,0,0},  // S_SKEL_STND
    {SPR_SKEL,1,10,{.acp2 = A_Look},S_SKEL_STND,0,0},   // S_SKEL_STND2
    {SPR_SKEL,0,2,{.acp2 = A_Chase},S_SKEL_RUN2,0,0},   // S_SKEL_RUN1
    {SPR_SKEL,0,2,{.acp2 = A_Chase},S_SKEL_RUN3,0,0},   // S_SKEL_RUN2
    {SPR_SKEL,1,2,{.acp2 = A_Chase},S_SKEL_RUN4,0,0},   // S_SKEL_RUN3
    {SPR_SKEL,1,2,{.acp2 = A_Chase},S_SKEL_RUN5,0,0},   // S_SKEL_RUN4
    {SPR_SKEL,2,2,{.acp2 = A_Chase},S_SKEL_RUN6,0,0},   // S_SKEL_RUN5
    {SPR_SKEL,2,2,{.acp2 = A_Chase},S_SKEL_RUN7,0,0},   // S_SKEL_RUN6
    {SPR_SKEL,3,2,{.acp2 = A_Chase},S_SKEL_RUN8,0,0},   // S_SKEL_RUN7
    {SPR_SKEL,3,2,{.acp2 = A_Chase},S_SKEL_RUN9,0,0},   // S_SKEL_RUN8
    {SPR_SKEL,4,2,{.acp2 = A_Chase},S_SKEL_RUN10,0,0},  // S_SKEL_RUN9
    {SPR_SKEL,4,2,{.acp2 = A_Chase},S_SKEL_RUN11,0,0},  // S_SKEL_RUN10
    {SPR_SKEL,5,2,{.acp2 = A_Chase},S_SKEL_RUN12,0,0},  // S_SKEL_RUN11
    {SPR_SKEL,5,2,{.acp2 = A_Chase},S_SKEL_RUN1,0,0},   // S_SKEL_RUN12
    {SPR_SKEL,6,0,{.acp2 = A_FaceTarget},S_SKEL_FIST2,0,0},     // S_SKEL_FIST1
    {SPR_SKEL,6,6,{.acp2 = A_SkelWhoosh},S_SKEL_FIST3,0,0},     // S_SKEL_FIST2
    {SPR_SKEL,7,6,{.acp2 = A_FaceTarget},S_SKEL_FIST4,0,0},     // S_SKEL_FIST3
    {SPR_SKEL,8,6,{.acp2 = A_SkelFist},S_SKEL_RUN1,0,0},        // S_SKEL_FIST4
    {SPR_SKEL,32777,0,{.acp2 = A_FaceTarget},S_SKEL_MISS2,0,0}, // S_SKEL_MISS1
    {SPR_SKEL,32777,10,{.acp2 = A_FaceTarget},S_SKEL_MISS3,0,0},        // S_SKEL_MISS2
    {SPR_SKEL,10,10,{.acp2 = A_SkelMissile},S_SKEL_MISS4,0,0},  // S_SKEL_MISS3
    {SPR_SKEL,10,10,{.acp2 = A_FaceTarget},S_SKEL_RUN1,0,0},    // S_SKEL_MISS4
    {SPR_SKEL,11,5,{NULL},S_SKEL_PAIN2,0,0},    // S_SKEL_PAIN
    {SPR_SKEL,11,5,{.acp2 = A_Pain},S_SKEL_RUN1,0,0},   // S_SKEL_PAIN2
    {SPR_SKEL,11,7,{NULL},S_SKEL_DIE2,0,0},     // S_SKEL_DIE1
    {SPR_SKEL,12,7,{NULL},S_SKEL_DIE3,0,0},     // S_SKEL_DIE2
    {SPR_SKEL,13,7,{.acp2 = A_Scream},S_SKEL_DIE4,0,0}, // S_SKEL_DIE3
    {SPR_SKEL,14,7,{.acp2 = A_Fall},S_SKEL_DIE5,0,0},   // S_SKEL_DIE4
    ...
    {SPR_FATT,0,15,{.acp2 = A_Look},S_FATT_STND2,0,0},  // S_FATT_STND
    {SPR_FATT,1,15,{.acp2 = A_Look},S_FATT_STND,0,0},   // S_FATT_STND2
    {SPR_FATT,0,4,{.acp2 = A_Chase},S_FATT_RUN2,0,0},   // S_FATT_RUN1
    {SPR_FATT,0,4,{.acp2 = A_Chase},S_FATT_RUN3,0,0},   // S_FATT_RUN2
    {SPR_FATT,1,4,{.acp2 = A_Chase},S_FATT_RUN4,0,0},   // S_FATT_RUN3
    {SPR_FATT,1,4,{.acp2 = A_Chase},S_FATT_RUN5,0,0},   // S_FATT_RUN4
    {SPR_FATT,2,4,{.acp2 = A_Chase},S_FATT_RUN6,0,0},   // S_FATT_RUN5
    {SPR_FATT,2,4,{.acp2 = A_Chase},S_FATT_RUN7,0,0},   // S_FATT_RUN6
    {SPR_FATT,3,4,{.acp2 = A_Chase},S_FATT_RUN8,0,0},   // S_FATT_RUN7
    {SPR_FATT,3,4,{.acp2 = A_Chase},S_FATT_RUN9,0,0},   // S_FATT_RUN8
    {SPR_FATT,4,4,{.acp2 = A_Chase},S_FATT_RUN10,0,0},  // S_FATT_RUN9
    {SPR_FATT,4,4,{.acp2 = A_Chase},S_FATT_RUN11,0,0},  // S_FATT_RUN10
    {SPR_FATT,5,4,{.acp2 = A_Chase},S_FATT_RUN12,0,0},  // S_FATT_RUN11
    {SPR_FATT,5,4,{.acp2 = A_Chase},S_FATT_RUN1,0,0},   // S_FATT_RUN12
    {SPR_FATT,6,20,{.acp2 = A_FatRaise},S_FATT_ATK2,0,0},       // S_FATT_ATK1
    {SPR_FATT,32775,10,{.acp2 = A_FatAttack1},S_FATT_ATK3,0,0}, // S_FATT_ATK2
    {SPR_FATT,8,5,{.acp2 = A_FaceTarget},S_FATT_ATK4,0,0},      // S_FATT_ATK3
    {SPR_FATT,6,5,{.acp2 = A_FaceTarget},S_FATT_ATK5,0,0},      // S_FATT_ATK4
    {SPR_FATT,32775,10,{.acp2 = A_FatAttack2},S_FATT_ATK6,0,0}, // S_FATT_ATK5
    {SPR_FATT,8,5,{.acp2 = A_FaceTarget},S_FATT_ATK7,0,0},      // S_FATT_ATK6
    {SPR_FATT,6,5,{.acp2 = A_FaceTarget},S_FATT_ATK8,0,0},      // S_FATT_ATK7
    {SPR_FATT,32775,10,{.acp2 = A_FatAttack3},S_FATT_ATK9,0,0}, // S_FATT_ATK8
    {SPR_FATT,8,5,{.acp2 = A_FaceTarget},S_FATT_ATK10,0,0},     // S_FATT_ATK9
    {SPR_FATT,6,5,{.acp2 = A_FaceTarget},S_FATT_RUN1,0,0},      // S_FATT_ATK10
    {SPR_FATT,9,3,{NULL},S_FATT_PAIN2,0,0},     // S_FATT_PAIN
    {SPR_FATT,9,3,{.acp2 = A_Pain},S_FATT_RUN1,0,0},    // S_FATT_PAIN2
    {SPR_FATT,10,6,{NULL},S_FATT_DIE2,0,0},     // S_FATT_DIE1
    {SPR_FATT,11,6,{.acp2 = A_Scream},S_FATT_DIE3,0,0}, // S_FATT_DIE2
    {SPR_FATT,12,6,{.acp2 = A_Fall},S_FATT_DIE4,0,0},   // S_FATT_DIE3
    ...
    {SPR_FATT,19,-1,{.acp2 = A_BossDeath},S_NULL,0,0},  // S_FATT_DIE10
    ...
    {SPR_CPOS,0,10,{.acp2 = A_Look},S_CPOS_STND2,0,0},  // S_CPOS_STND
    {SPR_CPOS,1,10,{.acp2 = A_Look},S_CPOS_STND,0,0},   // S_CPOS_STND2
    {SPR_CPOS,0,3,{.acp2 = A_Chase},S_CPOS_RUN2,0,0},   // S_CPOS_RUN1
    {SPR_CPOS,0,3,{.acp2 = A_Chase},S_CPOS_RUN3,0,0},   // S_CPOS_RUN2
    {SPR_CPOS,1,3,{.acp2 = A_Chase},S_CPOS_RUN4,0,0},   // S_CPOS_RUN3
    {SPR_CPOS,1,3,{.acp2 = A_Chase},S_CPOS_RUN5,0,0},   // S_CPOS_RUN4
    {SPR_CPOS,2,3,{.acp2 = A_Chase},S_CPOS_RUN6,0,0},   // S_CPOS_RUN5
    {SPR_CPOS,2,3,{.acp2 = A_Chase},S_CPOS_RUN7,0,0},   // S_CPOS_RUN6
    {SPR_CPOS,3,3,{.acp2 = A_Chase},S_CPOS_RUN8,0,0},   // S_CPOS_RUN7
    {SPR_CPOS,3,3,{.acp2 = A_Chase},S_CPOS_RUN1,0,0},   // S_CPOS_RUN8
    {SPR_CPOS,4,10,{.acp2 = A_FaceTarget},S_CPOS_ATK2,0,0},     // S_CPOS_ATK1
    {SPR_CPOS,32773,4,{.acp2 = A_CPosAttack},S_CPOS_ATK3,0,0},  // S_CPOS_ATK2
    {SPR_CPOS,32772,4,{.acp2 = A_CPosAttack},S_CPOS_ATK4,0,0},  // S_CPOS_ATK3
    {SPR_CPOS,5,1,{.acp2 = A_CPosRefire},S_CPOS_ATK2,0,0},      // S_CPOS_ATK4
    {SPR_CPOS,6,3,{NULL},S_CPOS_PAIN2,0,0},     // S_CPOS_PAIN
    {SPR_CPOS,6,3,{.acp2 = A_Pain},S_CPOS_RUN1,0,0},    // S_CPOS_PAIN2
    {SPR_CPOS,7,5,{NULL},S_CPOS_DIE2,0,0},      // S_CPOS_DIE1
    {SPR_CPOS,8,5,{.acp2 = A_Scream},S_CPOS_DIE3,0,0},  // S_CPOS_DIE2
    {SPR_CPOS,9,5,{.acp2 = A_Fall},S_CPOS_DIE4,0,0},    // S_CPOS_DIE3
    ...
    {SPR_CPOS,15,5,{.acp2 = A_XScream},S_CPOS_XDIE3,0,0},       // S_CPOS_XDIE2
    {SPR_CPOS,16,5,{.acp2 = A_Fall},S_CPOS_XDIE4,0,0},  // S_CPOS_XDIE3
    ...
    {SPR_TROO,0,10,{.acp2 = A_Look},S_TROO_STND2,0,0},  // S_TROO_STND
    {SPR_TROO,1,10,{.acp2 = A_Look},S_TROO_STND,0,0},   // S_TROO_STND2
    {SPR_TROO,0,3,{.acp2 = A_Chase},S_TROO_RUN2,0,0},   // S_TROO_RUN1
    {SPR_TROO,0,3,{.acp2 = A_Chase},S_TROO_RUN3,0,0},   // S_TROO_RUN2
    {SPR_TROO,1,3,{.acp2 = A_Chase},S_TROO_RUN4,0,0},   // S_TROO_RUN3
    {SPR_TROO,1,3,{.acp2 = A_Chase},S_TROO_RUN5,0,0},   // S_TROO_RUN4
    {SPR_TROO,2,3,{.acp2 = A_Chase},S_TROO_RUN6,0,0},   // S_TROO_RUN5
    {SPR_TROO,2,3,{.acp2 = A_Chase},S_TROO_RUN7,0,0},   // S_TROO_RUN6
    {SPR_TROO,3,3,{.acp2 = A_Chase},S_TROO_RUN8,0,0},   // S_TROO_RUN7
    {SPR_TROO,3,3,{.acp2 = A_Chase},S_TROO_RUN1,0,0},   // S_TROO_RUN8
    {SPR_TROO,4,8,{.acp2 = A_FaceTarget},S_TROO_ATK2,0,0},      // S_TROO_ATK1
    {SPR_TROO,5,8,{.acp2 = A_FaceTarget},S_TROO_ATK3,0,0},      // S_TROO_ATK2
    {SPR_TROO,6,6,{.acp2 = A_TroopAttack},S_TROO_RUN1,0,0},     // S_TROO_ATK3
    {SPR_TROO,7,2,{NULL},S_TROO_PAIN2,0,0},     // S_TROO_PAIN
    {SPR_TROO,7,2,{.acp2 = A_Pain},S_TROO_RUN1,0,0},    // S_TROO_PAIN2
    {SPR_TROO,8,8,{NULL},S_TROO_DIE2,0,0},      // S_TROO_DIE1
    {SPR_TROO,9,8,{.acp2 = A_Scream},S_TROO_DIE3,0,0},  // S_TROO_DIE2
    {SPR_TROO,10,6,{NULL},S_TROO_DIE4,0,0},     // S_TROO_DIE3
    {SPR_TROO,11,6,{.acp2 = A_Fall},S_TROO_DIE5,0,0},   // S_TROO_DIE4
    {SPR_TROO,12,-1,{NULL},S_NULL,0,0}, // S_TROO_DIE5
    {SPR_TROO,13,5,{NULL},S_TROO_XDIE2,0,0},    // S_TROO_XDIE1
    {SPR_TROO,14,5,{.acp2 = A_XScream},S_TROO_XDIE3,0,0},       // S_TROO_XDIE2
    {SPR_TROO,15,5,{NULL},S_TROO_XDIE4,0,0},    // S_TROO_XDIE3
    {SPR_TROO,16,5,{.acp2 = A_Fall},S_TROO_XDIE5,0,0},  // S_TROO_XDIE4
    ...
    {SPR_SARG,0,10,{.acp2 = A_Look},S_SARG_STND2,0,0},  // S_SARG_STND
    {SPR_SARG,1,10,{.acp2 = A_Look},S_SARG_STND,0,0},   // S_SARG_STND2
    {SPR_SARG,0,2,{.acp2 = A_Chase},S_SARG_RUN2,0,0},   // S_SARG_RUN1
    {SPR_SARG,0,2,{.acp2 = A_Chase},S_SARG_RUN3,0,0},   // S_SARG_RUN2
    {SPR_SARG,1,2,{.acp2 = A_Chase},S_SARG_RUN4,0,0},   // S_SARG_RUN3
    {SPR_SARG,1,2,{.acp2 = A_Chase},S_SARG_RUN5,0,0},   // S_SARG_RUN4
    {SPR_SARG,2,2,{.acp2 = A_Chase},S_SARG_RUN6,0,0},   // S_SARG_RUN5
    {SPR_SARG,2,2,{.acp2 = A_Chase},S_SARG_RUN7,0,0},   // S_SARG_RUN6
    {SPR_SARG,3,2,{.acp2 = A_Chase},S_SARG_RUN8,0,0},   // S_SARG_RUN7
    {SPR_SARG,3,2,{.acp2 = A_Chase},S_SARG_RUN1,0,0},   // S_SARG_RUN8
    {SPR_SARG,4,8,{.acp2 = A_FaceTarget},S_SARG_ATK2,0,0},      // S_SARG_ATK1
    {SPR_SARG,5,8,{.acp2 = A_FaceTarget},S_SARG_ATK3,0,0},      // S_SARG_ATK2
    {SPR_SARG,6,8,{.acp2 = A_SargAttack},S_SARG_RUN1,0,0},      // S_SARG_ATK3
    {SPR_SARG,7,2,{NULL},S_SARG_PAIN2,0,0},     // S_SARG_PAIN
    {SPR_SARG,7,2,{.acp2 = A_Pain},S_SARG_RUN1,0,0},    // S_SARG_PAIN2
    {SPR_SARG,8,8,{NULL},S_SARG_DIE2,0,0},      // S_SARG_DIE1
    {SPR_SARG,9,8,{.acp2 = A_Scream},S_SARG_DIE3,0,0},  // S_SARG_DIE2
    {SPR_SARG,10,4,{NULL},S_SARG_DIE4,0,0},     // S_SARG_DIE3
    {SPR_SARG,11,4,{.acp2 = A_Fall},S_SARG_DIE5,0,0},   // S_SARG_DIE4
    ...
    {SPR_HEAD,0,10,{.acp2 = A_Look},S_HEAD_STND,0,0},   // S_HEAD_STND
    {SPR_HEAD,0,3,{.acp2 = A_Chase},S_HEAD_RUN1,0,0},   // S_HEAD_RUN1
    {SPR_HEAD,1,5,{.acp2 = A_FaceTarget},S_HEAD_ATK2,0,0},      // S_HEAD_ATK1
    {SPR_HEAD,2,5,{.acp2 = A_FaceTarget},S_HEAD_ATK3,0,0},      // S_HEAD_ATK2
    {SPR_HEAD,32771,5,{.acp2 = A_HeadAttack},S_HEAD_RUN1,0,0},  // S_HEAD_ATK3
    {SPR_HEAD,4,3,{NULL},S_HEAD_PAIN2,0,0},     // S_HEAD_PAIN
    {SPR_HEAD,4,3,{.acp2 = A_Pain},S_HEAD_PAIN3,0,0},   // S_HEAD_PAIN2
    {SPR_HEAD,5,6,{NULL},S_HEAD_RUN1,0,0},      // S_HEAD_PAIN3
    {SPR_HEAD,6,8,{NULL},S_HEAD_DIE2,0,0},      // S_HEAD_DIE1
    {SPR_HEAD,7,8,{.acp2 = A_Scream},S_HEAD_DIE3,0,0},  // S_HEAD_DIE2
    {SPR_HEAD,8,8,{NULL},S_HEAD_DIE4,0,0},      // S_HEAD_DIE3
    {SPR_HEAD,9,8,{NULL},S_HEAD_DIE5,0,0},      // S_HEAD_DIE4
    {SPR_HEAD,10,8,{.acp2 = A_Fall},S_HEAD_DIE6,0,0},   // S_HEAD_DIE5
    ...
    {SPR_BOSS,0,10,{.acp2 = A_Look},S_BOSS_STND2,0,0},  // S_BOSS_STND
    {SPR_BOSS,1,10,{.acp2 = A_Look},S_BOSS_STND,0,0},   // S_BOSS_STND2
    {SPR_BOSS,0,3,{.acp2 = A_Chase},S_BOSS_RUN2,0,0},   // S_BOSS_RUN1
    {SPR_BOSS,0,3,{.acp2 = A_Chase},S_BOSS_RUN3,0,0},   // S_BOSS_RUN2
    {SPR_BOSS,1,3,{.acp2 = A_Chase},S_BOSS_RUN4,0,0},   // S_BOSS_RUN3
    {SPR_BOSS,1,3,{.acp2 = A_Chase},S_BOSS_RUN5,0,0},   // S_BOSS_RUN4
    {SPR_BOSS,2,3,{.acp2 = A_Chase},S_BOSS_RUN6,0,0},   // S_BOSS_RUN5
    {SPR_BOSS,2,3,{.acp2 = A_Chase},S_BOSS_RUN7,0,0},   // S_BOSS_RUN6
    {SPR_BOSS,3,3,{.acp2 = A_Chase},S_BOSS_RUN8,0,0},   // S_BOSS_RUN7
    {SPR_BOSS,3,3,{.acp2 = A_Chase},S_BOSS_RUN1,0,0},   // S_BOSS_RUN8
    {SPR_BOSS,4,8,{.acp2 = A_FaceTarget},S_BOSS_ATK2,0,0},      // S_BOSS_ATK1
    {SPR_BOSS,5,8,{.acp2 = A_FaceTarget},S_BOSS_ATK3,0,0},      // S_BOSS_ATK2
    {SPR_BOSS,6,8,{.acp2 = A_BruisAttack},S_BOSS_RUN1,0,0},     // S_BOSS_ATK3
    {SPR_BOSS,7,2,{NULL},S_BOSS_PAIN2,0,0},     // S_BOSS_PAIN
    {SPR_BOSS,7,2,{.acp2 = A_Pain},S_BOSS_RUN1,0,0},    // S_BOSS_PAIN2
    {SPR_BOSS,8,8,{NULL},S_BOSS_DIE2,0,0},      // S_BOSS_DIE1
    {SPR_BOSS,9,8,{.acp2 = A_Scream},S_BOSS_DIE3,0,0},  // S_BOSS_DIE2
    {SPR_BOSS,10,8,{NULL},S_BOSS_DIE4,0,0},     // S_BOSS_DIE3
    {SPR_BOSS,11,8,{.acp2 = A_Fall},S_BOSS_DIE5,0,0},   // S_BOSS_DIE4
    {SPR_BOSS,12,8,{NULL},S_BOSS_DIE6,0,0},     // S_BOSS_DIE5
    {SPR_BOSS,13,8,{NULL},S_BOSS_DIE7,0,0},     // S_BOSS_DIE6
    {SPR_BOSS,14,-1,{.acp2 = A_BossDeath},S_NULL,0,0},  // S_BOSS_DIE7
    ...
    {SPR_BOS2,0,10,{.acp2 = A_Look},S_BOS2_STND2,0,0},  // S_BOS2_STND
    {SPR_BOS2,1,10,{.acp2 = A_Look},S_BOS2_STND,0,0},   // S_BOS2_STND2
    {SPR_BOS2,0,3,{.acp2 = A_Chase},S_BOS2_RUN2,0,0},   // S_BOS2_RUN1
    {SPR_BOS2,0,3,{.acp2 = A_Chase},S_BOS2_RUN3,0,0},   // S_BOS2_RUN2
    {SPR_BOS2,1,3,{.acp2 = A_Chase},S_BOS2_RUN4,0,0},   // S_BOS2_RUN3
    {SPR_BOS2,1,3,{.acp2 = A_Chase},S_BOS2_RUN5,0,0},   // S_BOS2_RUN4
    {SPR_BOS2,2,3,{.acp2 = A_Chase},S_BOS2_RUN6,0,0},   // S_BOS2_RUN5
    {SPR_BOS2,2,3,{.acp2 = A_Chase},S_BOS2_RUN7,0,0},   // S_BOS2_RUN6
    {SPR_BOS2,3,3,{.acp2 = A_Chase},S_BOS2_RUN8,0,0},   // S_BOS2_RUN7
    {SPR_BOS2,3,3,{.acp2 = A_Chase},S_BOS2_RUN1,0,0},   // S_BOS2_RUN8
    {SPR_BOS2,4,8,{.acp2 = A_FaceTarget},S_BOS2_ATK2,0,0},      // S_BOS2_ATK1
    {SPR_BOS2,5,8,{.acp2 = A_FaceTarget},S_BOS2_ATK3,0,0},      // S_BOS2_ATK2
    {SPR_BOS2,6,8,{.acp2 = A_BruisAttack},S_BOS2_RUN1,0,0},     // S_BOS2_ATK3
    {SPR_BOS2,7,2,{NULL},S_BOS2_PAIN2,0,0},     // S_BOS2_PAIN
    {SPR_BOS2,7,2,{.acp2 = A_Pain},S_BOS2_RUN1,0,0},    // S_BOS2_PAIN2
    {SPR_BOS2,8,8,{NULL},S_BOS2_DIE2,0,0},      // S_BOS2_DIE1
    {SPR_BOS2,9,8,{.acp2 = A_Scream},S_BOS2_DIE3,0,0},  // S_BOS2_DIE2
    {SPR_BOS2,10,8,{NULL},S_BOS2_DIE4,0,0},     // S_BOS2_DIE3
    {SPR_BOS2,11,8,{.acp2 = A_Fall},S_BOS2_DIE5,0,0},   // S_BOS2_DIE4
    ...
    {SPR_SKUL,32768,10,{.acp2 = A_Look},S_SKULL_STND2,0,0},     // S_SKULL_STND
    {SPR_SKUL,32769,10,{.acp2 = A_Look},S_SKULL_STND,0,0},      // S_SKULL_STND2
    {SPR_SKUL,32768,6,{.acp2 = A_Chase},S_SKULL_RUN2,0,0},      // S_SKULL_RUN1
    {SPR_SKUL,32769,6,{.acp2 = A_Chase},S_SKULL_RUN1,0,0},      // S_SKULL_RUN2
    {SPR_SKUL,32770,10,{.acp2 = A_FaceTarget},S_SKULL_ATK2,0,0},        // S_SKULL_ATK1
    {SPR_SKUL,32771,4,{.acp2 = A_SkullAttack},S_SKULL_ATK3,0,0},        // S_SKULL_ATK2
    ...
    {SPR_SKUL,32772,3,{.acp2 = A_Pain},S_SKULL_RUN1,0,0},       // S_SKULL_PAIN2
    {SPR_SKUL,32773,6,{NULL},S_SKULL_DIE2,0,0}, // S_SKULL_DIE1
    {SPR_SKUL,32774,6,{.acp2 = A_Scream},S_SKULL_DIE3,0,0},     // S_SKULL_DIE2
    {SPR_SKUL,32775,6,{NULL},S_SKULL_DIE4,0,0}, // S_SKULL_DIE3
    {SPR_SKUL,32776,6,{.acp2 = A_Fall},S_SKULL_DIE5,0,0},       // S_SKULL_DIE4
    {SPR_SKUL,9,6,{NULL},S_SKULL_DIE6,0,0},     // S_SKULL_DIE5
    {SPR_SKUL,10,6,{NULL},S_NULL,0,0},  // S_SKULL_DIE6
    {SPR_SPID,0,10,{.acp2 = A_Look},S_SPID_STND2,0,0},  // S_SPID_STND
    {SPR_SPID,1,10,{.acp2 = A_Look},S_SPID_STND,0,0},   // S_SPID_STND2
    {SPR_SPID,0,3,{.acp2 = A_Metal},S_SPID_RUN2,0,0},   // S_SPID_RUN1
    {SPR_SPID,0,3,{.acp2 = A_Chase},S_SPID_RUN3,0,0},   // S_SPID_RUN2
    {SPR_SPID,1,3,{.acp2 = A_Chase},S_SPID_RUN4,0,0},   // S_SPID_RUN3
    {SPR_SPID,1,3,{.acp2 = A_Chase},S_SPID_RUN5,0,0},   // S_SPID_RUN4
    {SPR_SPID,2,3,{.acp2 = A_Metal},S_SPID_RUN6,0,0},   // S_SPID_RUN5
    {SPR_SPID,2,3,{.acp2 = A_Chase},S_SPID_RUN7,0,0},   // S_SPID_RUN6
    {SPR_SPID,3,3,{.acp2 = A_Chase},S_SPID_RUN8,0,0},   // S_SPID_RUN7
    {SPR_SPID,3,3,{.acp2 = A_Chase},S_SPID_RUN9,0,0},   // S_SPID_RUN8
    {SPR_SPID,4,3,{.acp2 = A_Metal},S_SPID_RUN10,0,0},  // S_SPID_RUN9
    {SPR_SPID,4,3,{.acp2 = A_Chase},S_SPID_RUN11,0,0},  // S_SPID_RUN10
    {SPR_SPID,5,3,{.acp2 = A_Chase},S_SPID_RUN12,0,0},  // S_SPID_RUN11
    {SPR_SPID,5,3,{.acp2 = A_Chase},S_SPID_RUN1,0,0},   // S_SPID_RUN12
    {SPR_SPID,32768,20,{.acp2 = A_FaceTarget},S_SPID_ATK2,0,0}, // S_SPID_ATK1
    {SPR_SPID,32774,4,{.acp2 = A_SPosAttack},S_SPID_ATK3,0,0},  // S_SPID_ATK2
    {SPR_SPID,32775,4,{.acp2 = A_SPosAttack},S_SPID_ATK4,0,0},  // S_SPID_ATK3
    {SPR_SPID,32775,1,{.acp2 = A_SpidRefire},S_SPID_ATK2,0,0},  // S_SPID_ATK4
    {SPR_SPID,8,3,{NULL},S_SPID_PAIN2,0,0},     // S_SPID_PAIN
    {SPR_SPID,8,3,{.acp2 = A_Pain},S_SPID_RUN1,0,0},    // S_SPID_PAIN2
    {SPR_SPID,9,20,{.acp2 = A_Scream},S_SPID_DIE2,0,0}, // S_SPID_DIE1
    {SPR_SPID,10,10,{.acp2 = A_Fall},S_SPID_DIE3,0,0},  // S_SPID_DIE2
    ...
    {SPR_SPID,18,-1,{.acp2 = A_BossDeath},S_NULL,0,0},  // S_SPID_DIE11
    {SPR_BSPI,0,10,{.acp2 = A_Look},S_BSPI_STND2,0,0},  // S_BSPI_STND
    {SPR_BSPI,1,10,{.acp2 = A_Look},S_BSPI_STND,0,0},   // S_BSPI_STND2
    {SPR_BSPI,0,20,{NULL},S_BSPI_RUN1,0,0},     // S_BSPI_SIGHT
    {SPR_BSPI,0,3,{.acp2 = A_BabyMetal},S_BSPI_RUN2,0,0},       // S_BSPI_RUN1
    {SPR_BSPI,0,3,{.acp2 = A_Chase},S_BSPI_RUN3,0,0},   // S_BSPI_RUN2
    {SPR_BSPI,1,3,{.acp2 = A_Chase},S_BSPI_RUN4,0,0},   // S_BSPI_RUN3
    {SPR_BSPI,1,3,{.acp2 = A_Chase},S_BSPI_RUN5,0,0},   // S_BSPI_RUN4
    {SPR_BSPI,2,3,{.acp2 = A_Chase},S_BSPI_RUN6,0,0},   // S_BSPI_RUN5
    {SPR_BSPI,2,3,{.acp2 = A_Chase},S_BSPI_RUN7,0,0},   // S_BSPI_RUN6
    {SPR_BSPI,3,3,{.acp2 = A_BabyMetal},S_BSPI_RUN8,0,0},       // S_BSPI_RUN7
    {SPR_BSPI,3,3,{.acp2 = A_Chase},S_BSPI_RUN9,0,0},   // S_BSPI_RUN8
    {SPR_BSPI,4,3,{.acp2 = A_Chase},S_BSPI_RUN10,0,0},  // S_BSPI_RUN9
    {SPR_BSPI,4,3,{.acp2 = A_Chase},S_BSPI_RUN11,0,0},  // S_BSPI_RUN10
    {SPR_BSPI,5,3,{.acp2 = A_Chase},S_BSPI_RUN12,0,0},  // S_BSPI_RUN11
    {SPR_BSPI,5,3,{.acp2 = A_Chase},S_BSPI_RUN1,0,0},   // S_BSPI_RUN12
    {SPR_BSPI,32768,20,{.acp2 = A_FaceTarget},S_BSPI_ATK2,0,0}, // S_BSPI_ATK1
    {SPR_BSPI,32774,4,{.acp2 = A_BspiAttack},S_BSPI_ATK3,0,0},  // S_BSPI_ATK2
    {SPR_BSPI,32775,4,{NULL},S_BSPI_ATK4,0,0},  // S_BSPI_ATK3
    {SPR_BSPI,32775,1,{.acp2 = A_SpidRefire},S_BSPI_ATK2,0,0},  // S_BSPI_ATK4
    {SPR_BSPI,8,3,{NULL},S_BSPI_PAIN2,0,0},     // S_BSPI_PAIN
    {SPR_BSPI,8,3,{.acp2 = A_Pain},S_BSPI_RUN1,0,0},    // S_BSPI_PAIN2
    {SPR_BSPI,9,20,{.acp2 = A_Scream},S_BSPI_DIE2,0,0}, // S_BSPI_DIE1
    {SPR_BSPI,10,7,{.acp2 = A_Fall},S_BSPI_DIE3,0,0},   // S_BSPI_DIE2
    ...
    {SPR_BSPI,15,-1,{.acp2 = A_BossDeath},S_NULL,0,0},  // S_BSPI_DIE7
    ...
    {SPR_CYBR,0,10,{.acp2 = A_Look},S_CYBER_STND2,0,0}, // S_CYBER_STND
    {SPR_CYBR,1,10,{.acp2 = A_Look},S_CYBER_STND,0,0},  // S_CYBER_STND2
    {SPR_CYBR,0,3,{.acp2 = A_Hoof},S_CYBER_RUN2,0,0},   // S_CYBER_RUN1
    {SPR_CYBR,0,3,{.acp2 = A_Chase},S_CYBER_RUN3,0,0},  // S_CYBER_RUN2
    {SPR_CYBR,1,3,{.acp2 = A_Chase},S_CYBER_RUN4,0,0},  // S_CYBER_RUN3
    {SPR_CYBR,1,3,{.acp2 = A_Chase},S_CYBER_RUN5,0,0},  // S_CYBER_RUN4
    {SPR_CYBR,2,3,{.acp2 = A_Chase},S_CYBER_RUN6,0,0},  // S_CYBER_RUN5
    {SPR_CYBR,2,3,{.acp2 = A_Chase},S_CYBER_RUN7,0,0},  // S_CYBER_RUN6
    {SPR_CYBR,3,3,{.acp2 = A_Metal},S_CYBER_RUN8,0,0},  // S_CYBER_RUN7
    {SPR_CYBR,3,3,{.acp2 = A_Chase},S_CYBER_RUN1,0,0},  // S_CYBER_RUN8
    {SPR_CYBR,4,6,{.acp2 = A_FaceTarget},S_CYBER_ATK2,0,0},     // S_CYBER_ATK1
    {SPR_CYBR,5,12,{.acp2 = A_CyberAttack},S_CYBER_ATK3,0,0},   // S_CYBER_ATK2
    {SPR_CYBR,4,12,{.acp2 = A_FaceTarget},S_CYBER_ATK4,0,0},    // S_CYBER_ATK3
    {SPR_CYBR,5,12,{.acp2 = A_CyberAttack},S_CYBER_ATK5,0,0},   // S_CYBER_ATK4
    {SPR_CYBR,4,12,{.acp2 = A_FaceTarget},S_CYBER_ATK6,0,0},    // S_CYBER_ATK5
    {SPR_CYBR,5,12,{.acp2 = A_CyberAttack},S_CYBER_RUN1,0,0},   // S_CYBER_ATK6
    {SPR_CYBR,6,10,{.acp2 = A_Pain},S_CYBER_RUN1,0,0},  // S_CYBER_PAIN
    {SPR_CYBR,7,10,{NULL},S_CYBER_DIE2,0,0},    // S_CYBER_DIE1
    {SPR_CYBR,8,10,{.acp2 = A_Scream},S_CYBER_DIE3,0,0},        // S_CYBER_DIE2
    ...
    {SPR_CYBR,12,10,{.acp2 = A_Fall},S_CYBER_DIE7,0,0}, // S_CYBER_DIE6
    ...
    {SPR_CYBR,15,-1,{.acp2 = A_BossDeath},S_NULL,0,0},  // S_CYBER_DIE10
    {SPR_PAIN,0,10,{.acp2 = A_Look},S_PAIN_STND,0,0},   // S_PAIN_STND
    {SPR_PAIN,0,3,{.acp2 = A_Chase},S_PAIN_RUN2,0,0},   // S_PAIN_RUN1
    {SPR_PAIN,0,3,{.acp2 = A_Chase},S_PAIN_RUN3,0,0},   // S_PAIN_RUN2
    {SPR_PAIN,1,3,{.acp2 = A_Chase},S_PAIN_RUN4,0,0},   // S_PAIN_RUN3
    {SPR_PAIN,1,3,{.acp2 = A_Chase},S_PAIN_RUN5,0,0},   // S_PAIN_RUN4
    {SPR_PAIN,2,3,{.acp2 = A_Chase},S_PAIN_RUN6,0,0},   // S_PAIN_RUN5
    {SPR_PAIN,2,3,{.acp2 = A_Chase},S_PAIN_RUN1,0,0},   // S_PAIN_RUN6
    {SPR_PAIN,3,5,{.acp2 = A_FaceTarget},S_PAIN_ATK2,0,0},      // S_PAIN_ATK1
    {SPR_PAIN,4,5,{.acp2 = A_FaceTarget},S_PAIN_ATK3,0,0},      // S_PAIN_ATK2
    {SPR_PAIN,32773,5,{.acp2 = A_FaceTarget},S_PAIN_ATK4,0,0},  // S_PAIN_ATK3
    {SPR_PAIN,32773,0,{.acp2 = A_PainAttack},S_PAIN_RUN1,0,0},  // S_PAIN_ATK4
    {SPR_PAIN,6,6,{NULL},S_PAIN_PAIN2,0,0},     // S_PAIN_PAIN
    {SPR_PAIN,6,6,{.acp2 = A_Pain},S_PAIN_RUN1,0,0},    // S_PAIN_PAIN2
    {SPR_PAIN,32775,8,{NULL},S_PAIN_DIE2,0,0},  // S_PAIN_DIE1
    {SPR_PAIN,32776,8,{.acp2 = A_Scream},S_PAIN_DIE3,0,0},      // S_PAIN_DIE2
    {SPR_PAIN,32777,8,{NULL},S_PAIN_DIE4,0,0},  // S_PAIN_DIE3
    {SPR_PAIN,32778,8,{NULL},S_PAIN_DIE5,0,0},  // S_PAIN_DIE4
    {SPR_PAIN,32779,8,{.acp2 = A_PainDie},S_PAIN_DIE6,0,0},     // S_PAIN_DIE5
    ...
    {SPR_SSWV,0,10,{.acp2 = A_Look},S_SSWV_STND2,0,0},  // S_SSWV_STND
    {SPR_SSWV,1,10,{.acp2 = A_Look},S_SSWV_STND,0,0},   // S_SSWV_STND2
    {SPR_SSWV,0,3,{.acp2 = A_Chase},S_SSWV_RUN2,0,0},   // S_SSWV_RUN1
    {SPR_SSWV,0,3,{.acp2 = A_Chase},S_SSWV_RUN3,0,0},   // S_SSWV_RUN2
    {SPR_SSWV,1,3,{.acp2 = A_Chase},S_SSWV_RUN4,0,0},   // S_SSWV_RUN3
    {SPR_SSWV,1,3,{.acp2 = A_Chase},S_SSWV_RUN5,0,0},   // S_SSWV_RUN4
    {SPR_SSWV,2,3,{.acp2 = A_Chase},S_SSWV_RUN6,0,0},   // S_SSWV_RUN5
    {SPR_SSWV,2,3,{.acp2 = A_Chase},S_SSWV_RUN7,0,0},   // S_SSWV_RUN6
    {SPR_SSWV,3,3,{.acp2 = A_Chase},S_SSWV_RUN8,0,0},   // S_SSWV_RUN7
    {SPR_SSWV,3,3,{.acp2 = A_Chase},S_SSWV_RUN1,0,0},   // S_SSWV_RUN8
    {SPR_SSWV,4,10,{.acp2 = A_FaceTarget},S_SSWV_ATK2,0,0},     // S_SSWV_ATK1
    {SPR_SSWV,5,10,{.acp2 = A_FaceTarget},S_SSWV_ATK3,0,0},     // S_SSWV_ATK2
    {SPR_SSWV,32774,4,{.acp2 = A_CPosAttack},S_SSWV_ATK4,0,0},  // S_SSWV_ATK3
    {SPR_SSWV,5,6,{.acp2 = A_FaceTarget},S_SSWV_ATK5,0,0},      // S_SSWV_ATK4
    {SPR_SSWV,32774,4,{.acp2 = A_CPosAttack},S_SSWV_ATK6,0,0},  // S_SSWV_ATK5
    {SPR_SSWV,5,1,{.acp2 = A_CPosRefire},S_SSWV_ATK2,0,0},      // S_SSWV_ATK6
    {SPR_SSWV,7,3,{NULL},S_SSWV_PAIN2,0,0},     // S_SSWV_PAIN
    {SPR_SSWV,7,3,{.acp2 = A_Pain},S_SSWV_RUN1,0,0},    // S_SSWV_PAIN2
    {SPR_SSWV,8,5,{NULL},S_SSWV_DIE2,0,0},      // S_SSWV_DIE1
    {SPR_SSWV,9,5,{.acp2 = A_Scream},S_SSWV_DIE3,0,0},  // S_SSWV_DIE2
    {SPR_SSWV,10,5,{.acp2 = A_Fall},S_SSWV_DIE4,0,0},   // S_SSWV_DIE3
    ...
    {SPR_SSWV,14,5,{.acp2 = A_XScream},S_SSWV_XDIE3,0,0},       // S_SSWV_XDIE2
    {SPR_SSWV,15,5,{.acp2 = A_Fall},S_SSWV_XDIE4,0,0},  // S_SSWV_XDIE3
    ...
    {SPR_KEEN,2,6,{.acp2 = A_Scream},S_COMMKEEN4,0,0},  // S_COMMKEEN3
    ...
    {SPR_KEEN,10,6,{.acp2 = A_KeenDie},S_COMMKEEN12,0,0},// S_COMMKEEN11
    {SPR_KEEN,11,-1,{NULL},S_NULL,0,0},         // S_COMMKEEN12
    {SPR_KEEN,12,4,{NULL},S_KEENPAIN2,0,0},     // S_KEENPAIN
    {SPR_KEEN,12,8,{.acp2 = A_Pain},S_KEENSTND,0,0},    // S_KEENPAIN2
    {SPR_BBRN,0,-1,{NULL},S_NULL,0,0},          // S_BRAIN
    {SPR_BBRN,1,36,{.acp2 = A_BrainPain},S_BRAIN,0,0},  // S_BRAIN_PAIN
    {SPR_BBRN,0,100,{.acp2 = A_BrainScream},S_BRAIN_DIE2,0,0},  // S_BRAIN_DIE1
    {SPR_BBRN,0,10,{NULL},S_BRAIN_DIE3,0,0},    // S_BRAIN_DIE2
    {SPR_BBRN,0,10,{NULL},S_BRAIN_DIE4,0,0},    // S_BRAIN_DIE3
    {SPR_BBRN,0,-1,{.acp2 = A_BrainDie},S_NULL,0,0},    // S_BRAIN_DIE4
    {SPR_SSWV,0,10,{.acp2 = A_Look},S_BRAINEYE,0,0},    // S_BRAINEYE
    {SPR_SSWV,0,181,{.acp2 = A_BrainAwake},S_BRAINEYE1,0,0},    // S_BRAINEYESEE
    {SPR_SSWV,0,150,{.acp2 = A_BrainSpit},S_BRAINEYE1,0,0},     // S_BRAINEYE1
    {SPR_BOSF,32768,3,{.acp2 = A_SpawnSound},S_SPAWN2,0,0},     // S_SPAWN1
    {SPR_BOSF,32769,3,{.acp2 = A_SpawnFly},S_SPAWN3,0,0},       // S_SPAWN2
    {SPR_BOSF,32770,3,{.acp2 = A_SpawnFly},S_SPAWN4,0,0},       // S_SPAWN3
    {SPR_BOSF,32771,3,{.acp2 = A_SpawnFly},S_SPAWN1,0,0},       // S_SPAWN4
    {SPR_FIRE,32768,4,{.acp2 = A_Fire},S_SPAWNFIRE2,0,0},       // S_SPAWNFIRE1
    {SPR_FIRE,32769,4,{.acp2 = A_Fire},S_SPAWNFIRE3,0,0},       // S_SPAWNFIRE2
    {SPR_FIRE,32770,4,{.acp2 = A_Fire},S_SPAWNFIRE4,0,0},       // S_SPAWNFIRE3
    {SPR_FIRE,32771,4,{.acp2 = A_Fire},S_SPAWNFIRE5,0,0},       // S_SPAWNFIRE4
    {SPR_FIRE,32772,4,{.acp2 = A_Fire},S_SPAWNFIRE6,0,0},       // S_SPAWNFIRE5
    {SPR_FIRE,32773,4,{.acp2 = A_Fire},S_SPAWNFIRE7,0,0},       // S_SPAWNFIRE6
    {SPR_FIRE,32774,4,{.acp2 = A_Fire},S_SPAWNFIRE8,0,0},       // S_SPAWNFIRE7
    {SPR_FIRE,32775,4,{.acp2 = A_Fire},S_NULL,0,0},             // S_SPAWNFIRE8
    {SPR_MISL,32769,10,{NULL},S_BRAINEXPLODE2,0,0},     // S_BRAINEXPLODE1
    {SPR_MISL,32770,10,{NULL},S_BRAINEXPLODE3,0,0},     // S_BRAINEXPLODE2
    {SPR_MISL,32771,10,{.acp2 = A_BrainExplode},S_NULL,0,0},    // S_BRAINEXPLODE3
    ...
    {SPR_BEXP,32769,5,{.acp2 = A_Scream},S_BEXP3,0,0},  // S_BEXP2
    {SPR_BEXP,32770,5,{NULL},S_BEXP4,0,0},      // S_BEXP3
    {SPR_BEXP,32771,10,{.acp2 = A_Explode},S_BEXP5,0,0},        // S_BEXP4
